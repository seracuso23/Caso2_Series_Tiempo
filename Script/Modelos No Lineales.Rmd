...
RMSE=c(
  Metrics::rmse(sactnetusd_test, pronsetar1),
  Metrics::rmse(sactnetusd_test, pronsetar2),
  Metrics::rmse(sactnetusd_test, pronsetar3),
  Metrics::rmse(sactnetusd_test, pronsetar4)))%>%
  arrange(RMSE)%>%
  knitr::kable()
...
```{r , eval=F}
Metrics::rmse(sactnetusd_test,(prontar2))
Metrics::rmse(sactnetusd_test, (pronsetar3))
