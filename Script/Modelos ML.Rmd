...
train.crc<-training(splits)
test.crc<-testing(splits)
```



### Dolares
```{r dolares recopile datos y divídalos en conjuntos de prueba y entrenamiento.}
...
# Split Data 80/20
splits <- initial_time_split(dolares, prop = 0.975)

train.usd<-training(splits)
test.usd<-testing(splits)
```
